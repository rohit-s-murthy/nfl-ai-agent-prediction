import { TeamStats } from '../models/game';
...
const sampleTeamStats: { [key: string]: TeamStats } = {
    "KC": {
        wins: 14,
        losses: 3,
        ties: 0,
...
export const getTeamStats = (teamAbbreviation: string): TeamStats => {
...
export const getTeamByAbbreviation = (abbreviation: string): NFLTeam | undefined => {
